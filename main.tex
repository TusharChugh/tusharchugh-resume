...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Links}
\href{http://web.archive.org/web/20200803211659/http://tusharchugh.com/}{\custombold{\hl{tusharchugh.com}}} \\
...
\descript{| Sr. ML Software Engineer - Search Ranking}
...
\descript{| Perception - Self Driving Cars }
...
\begin{tightemize}
\item Envisioned, created and, \href{https://github.com/Microsoft/kinect-ripple}{\custombold{\hl{released}}} to public \href{https://www.youtube.com/watch?v=_0K4iZdMjLw}{\custombold{\hl{Kinect Ripple}}}
...
\begin{tightemize}
\item \href{https://mrsdprojects.ri.cmu.edu/2015teamb/media/fall-and-spring-videos/}{\custombold{\hl{Autonomous Water Taxi}}}: Implemented path-planning stack using SBPL and ROS. Created Occupancy Grip  Map (OGM), designed framework to add and inflate obstacle data to OGM, used ARA* algorithm as global planner
